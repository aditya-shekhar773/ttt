...
const Square = () => {
  ...
  return (
    <div className='App-header'>
       <h1 className='heading'>Tic Tac By Aditya</h1>
       ...
       <div className="button mt-12 text-3xl bg-red-800 rounded-md p-2 hover:bg-red-900">
          <button className=' text-3xl bg-red-800 rounded-md p-2 hover:bg-red-900'>End Game</button>
        </div>
